...
<div class="container-fluid" id="isi" >
  ...
  <div class="row">
    <div class="col-xs-4 col-xs-offset-4" id="produk-laris">
      <h3 style="font-family: Blacksword; font-size:2.2em;"><strong>Rumah Batik</strong></h3>
    </div>
  </div>
  ...
  <div class="container" id="produk">
    ...
    <img style="width: 1100px; height: 450px; margin-right: 1vw; margin-left: 1vw;" src="asset/img/beranda.jpg"></a>
    <!-- <img style src="asset/img/beranda.jpg"> -->
            </div>
